...
class ProgressScreenMarkerSelfies extends StatefulWidget {
  static String route = "ProgressScreenMarkerSelfies";
  @override
  _ProgressScreenState createState() => _ProgressScreenState();
}

class _ProgressScreenState extends State<ProgressScreenMarkerSelfies> {
  @override
