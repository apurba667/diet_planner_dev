...
class _AboutState extends State<About> {
  ...
  Widget build(BuildContext context) {
    ScreenUtil.init(context,
        designSize: Size(720, 1424), allowFontScaling: false);
      ...
      /* body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            if (teamPressed == true) funteampressed(),
            if (programPressed == true) funprogrampressed(),
            if (missionPressed == true) funmissionpressed(),
            if (faqPressed == true)
              Container(
                color: whiteColor,
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Container(child: arrowdire[index]))
                                ],
                              ),
                            ),
                            isTaped[index]
