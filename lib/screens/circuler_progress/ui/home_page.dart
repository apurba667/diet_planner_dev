...
final customWidth01 = CustomSliderWidths(trackWidth: 12, progressBarWidth: 12,shadowWidth: 1 );
...
final customWidth33 = CustomSliderWidths(trackWidth: 12, progressBarWidth: 12,shadowWidth: 1 );
final customColors33 = CustomSliderColors(
    trackColor: HexColor("#E9E9E9"),
    dotColor: Colors.transparent,
    hideShadow: true);

final CircularSliderAppearance appearance33 = CircularSliderAppearance(
  customWidths: customWidth33,
  customColors: customColors33,
  startAngle: 130,
  angleRange: 280,
  size: 180.0,
);
final viewModel33 = ProgressViewModel(
