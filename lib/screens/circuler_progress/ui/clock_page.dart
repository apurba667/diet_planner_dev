...
class ClockWidget extends StatelessWidget {
  ...
  const ClockWidget({required Key key, this.dateTime}) : super(key: key);
...
final customWidth01 =
    CustomSliderWidths(trackWidth: 2, progressBarWidth: 10, shadowWidth: 20, handlerSize: 20);
...
final CircularSliderAppearance appearance01 = CircularSliderAppearance(
    ...
    angleRange: 360,
    size: 350.0,
    animationEnabled: false, infoProperties: );
